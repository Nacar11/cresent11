        ...
        >
            ...
            >
                {toasts.map((toast, index) => {
                    ...
                    // Mapping classes for the close icon specifically
                    const svgClasses = {
                        message: "fill-current",
                        success: "fill-current",
                        warning: "fill-current",
                        error: "fill-current"
                    };
                                ...
                                <div className="w-full h-full flex items-center justify-between gap-4">
                                    ...
                                    {!toast.action && (
                                        <div className="flex gap-1">
                                            ...
                                            >
                                                <CloseIcon className={svgClasses[toast.type]} />
                                            </Button>
                                        </div>
                                    )}
                                </div>
...
const mountContainer = () => {
    ...
    el.className = "fixed bottom-0 right-0 z-[9999]"; // Mounting point wrapper
